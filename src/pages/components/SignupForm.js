...
const SuccessMessage = () => (
    <p className="max-w-sm text-sm p-3 bg-green-100 border rounded-md border-success text-success">
      ...
      <>
        ...
        <form className="max-w-sm" onSubmit={handleSubmit(onSubmit)}>
          <div className={formClass}>
            <input className={inputClass} disabled={isLoading} type="text" name="email" 
            ref={register({
            ...
            placeholder="John Wic" aria-label="Full name" />
